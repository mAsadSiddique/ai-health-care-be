import { IsDateString, IsMongoId, IsNotEmpty, IsNumber, IsString, Max, MaxLength, Min } from 'class-validator'
import { ApiProperty } from '@nestjs/swagger'

export class DoctorCreateAppointmentDTO {
    @ApiProperty({ description: 'Patient ID to create appointment for' })
    @IsNotEmpty()
    @IsMongoId({
